  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="container-pi absolute top-32 left-0 right-0 hidden md:flex justify-between items-start text-[11px] uppercase tracking-editorial font-mono text-slate-600"
      >
        <div>
          <div>København</div>
          <div className="text-midnight mt-1 tabular">55°40′34″N · 12°34′06″E</div>
        </div>
      ...
      <motion.div style={{ y, opacity }} className="container-pi relative">
        <div className="max-w-[1100px]">
          ...
          <h1 className="display-xl text-balance">
            <RevealText delay={0.25}>Strategisk</RevealText>
            <RevealText delay={0.35}>CFO-ledelse —</RevealText>
          ...
          >
            <MagneticButton href="#kontakt" strength={0.2}>
            ...
            <a
              href="#ydelser"
              className="text-sm text-slate-700 link-underline py-2"
            >
      ...
      >
        <div className="text-[11px] uppercase tracking-editorial font-mono text-slate-600">
        ...
        <motion.div
          ...
          className="text-[11px] uppercase tracking-editorial font-mono text-slate-600 flex flex-col items-center gap-2"
          aria-hidden
        >
          <span>Scroll</span>
